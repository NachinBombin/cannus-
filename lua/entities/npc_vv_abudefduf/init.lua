...
ENT.Model = {"models/animalia/fish/abudefduf.mdl"}
ENT.StartHealth = 3
...
ENT.Aquatic_AnimTbl_Calm = {"walk"}
ENT.Aquatic_AnimTbl_Alerted = {"run"}
ENT.IdleAlwaysWander = true
ENT.BloodColor = "Red"
ENT.EntitiesToNoCollide = {"npc_vv_abudefduf"}
